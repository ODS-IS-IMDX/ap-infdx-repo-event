...
import com.spatialid.app.api.application.dto.permission.ApiAuthDto;
import com.spatialid.app.api.application.dto.permission.ApiInfoDto;
import com.spatialid.app.api.application.dto.permission.GetApiAuthResponseDto;
import com.spatialid.app.api.constatnts.AccessControlInterceptorConstants;
...
public class AccessControlInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        // API利用権限参照からレスポンスを取得
        ResponseEntity<GetApiAuthResponseDto> responseEntity = new ResponseEntity<>(
